...
var Passport = {
    ...
    attributes: {
        ...
        password: { type: "string", minsize: 8, size: 180 },
        accessToken: { type: "string", size: 180 },
        ...
        provider: { type: "alphanumericdashed", size: 180 },
        identifier: { type: "string", size: 180 },
        //tokens     : { type: 'json' },
        ...
        // for more details
        resetPasswordToken: { type: "string", size: 180 },
